...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TestLibrary/TestLibrary.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TestLibrary/TestFramework.framework"
fi
